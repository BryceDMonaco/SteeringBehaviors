...
// Implements math described in https://gamedevelopment.tutsplus.com/understanding-steering-behaviors-seek--gamedev-849t
public class Seek : MonoBehaviour
{
    ...
    [SerializeField] private SeekType seekType = SeekType.WithSteering;
    ...
    void FixedUpdate()
    {
        switch (seekType)
        {
            case SeekType.WithoutSteering:
                SeekWithoutSteering();
                break;
            case SeekType.WithSteering:
                SeekWithSteering();
                break;
            default:
                Debug.Log("Unhandled seek type");
                break;
        }
    }
